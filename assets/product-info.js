    ...
    class ProductInfo extends HTMLElement {
      ...
      getSelectedVariant(productInfoNode) {
        const selectedVariant = productInfoNode.querySelector(
          'variant-selects [data-selected-variant], nvgd-variant-picker [data-selected-variant]'
        )?.innerHTML;
      ...
      updateOptionValues(html) {
        ...
        if (variantSelects) {
          const currentVariantSelects = this.variantSelectors;
          if (currentVariantSelects) {
            HTMLUpdateUtility.viewTransition(currentVariantSelects, variantSelects, this.preProcessHtmlCallbacks);
          }
          return;
        }

        const customVariantPicker = html.querySelector('nvgd-variant-picker');
        const currentCustomVariantPicker = this.querySelector('nvgd-variant-picker');
        if (customVariantPicker && currentCustomVariantPicker) {
          HTMLUpdateUtility.viewTransition(
            currentCustomVariantPicker,
            customVariantPicker,
            this.preProcessHtmlCallbacks
          );
        }
