...
Blank NAVEGaid Theme is a Shopify Online Store 2.0 starting point with merchant-editable sections, theme blocks, and storefront templates. It installs with a visible, neutral version of the original homepage and page layouts, a plain header and footer, no demo media or category copy, and monochrome colors. Catalog images appear only when the merchant supplies them. The [Fluid documentation](https://doc.navegaid.com/theme/fluid/welcome) describes the retained section library.
